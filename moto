  ...
  <body>
       ...
       <div class=" jumbotron">
                    ...
                    <div class="container well" style="margin-top: 70px;">
                             ...
                             Header pic: <input type="file" name="hea" > <br><br>
                             Broucer: <input type="file" name="down" > <br>
                             ...
                             BHK avilable: <input type="checkbox" name="bhk[]" value="1 BHK"> 1 BHK  
                                                      ...
                                                      <input type="checkbox" name="bhk[]" value="4 BHK"> 4 BHK
                                                      <input type="checkbox" name="bhk[]" value="5 BHK"> 5 BHK
                                                      <input type="checkbox" name="bhk[]" value="6 BHK"> 6 BHK             
