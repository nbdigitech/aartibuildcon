           ...
           <div class="toolbar">
                  ...
                  @foreach($applyuser as $row)
                        <tr>
                          ...
                          <td>{{$row->email}}</td>
                          <td>{{$row->Mobile}}</td>
                            <form action="{{route('Admin/Business/EditSession')}}" method="post">
                              {{csrf_field()}}
                            <td class="td-actions text-right">
                              <input type="hidden" name="Edit" value="{{$row->id}}">
                            <button type="submit" rel="tooltip" class="btn btn-success" style="background-color: #5BBC2E; padding:10px; padding-left: 20px; box-shadow: none; margin-right: 10px; padding-right: 20px;">
                              Remark
                            </button>
                            </form>
                            <button type="button" rel="tooltip" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right" onclick="delete_function('{{$row->id}}')" style="background-color: #5BBC2E; padding:10px; box-shadow: none; padding-left: 15px; padding-right: 15px;">
                              Delete
                            </button>
                          </td>
                        </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row" style="padding-bottom: 50px;">
        ...
        <div class="col-sm-4">
          <button type="button" class="btn btn-danger" data-dismiss="modal" style="color:white; width: 100%; background-color: #FFC627;">No</button>
        </div>
        <div class="col-sm-2"></div>
      </div>
    </div>
...
<div class="modal" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header"  style="background-color: #FFC627; color:white;">
              <h4 class="modal-title" style="margin-top: -10px; margin-bottom: 10px;">Are You Sure Remove It ?</h4>
              <button type="button" class="close" data-dismiss="modal" style="color:white;">&times;</button>
            </div>
            ...
            <div class="modal-body">
              ...
              <div class="container">      
                    <form action="{{route('Admin/Business/EditSession')}}" method="post">
                      {{csrf_field()}}
                        <input type="hidden" name="EditId" id="remId" />
