...
<div class="container-fluid">
  <div class="row">
        <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="@if(isset($edit->id)) {{route('Admin/FacebookLead/SendSMS')}} @else {{route('Admin/FacebookLead/SendSMS')}} @endif" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card ">
                  ...
                  <div style="background-color: #274CBF; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>
                       Send SMS                     <a href="{{route('Admin/FacebookLead')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#274CBF;">Manage</a></h4>
                  </div>
                  ...
                  <div class="row" style="margin-bottom: 30px;">
                    <label class="col-sm-2 col-form-label">Name :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text" disabled name="Name" required  class="form-control" value="@if(isset($edit->id)) {{$edit->Name}} @endif">
                      </div>
                    </div>
                     ...
                     <label class="col-sm-2 col-form-label">Mobile :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text" disabled required name="Mobile"  class="form-control" value="@if(isset($edit->id)) {{$edit->Mobile}} @endif">
                          <input type="hidden" required name="MobileNumber"  class="form-control" value="@if(isset($edit->id)) {{$edit->Mobile}} @endif">
                      </div>
                    </div>
                    ...
                    <label class="col-sm-2 col-form-label">Lead Date :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                        <input type="date" disabled name="Date"  class="form-control" value="@if(isset($edit->id)) {{$edit->Date}} @endif">
