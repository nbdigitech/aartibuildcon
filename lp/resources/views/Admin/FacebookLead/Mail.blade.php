...
<div class="container-fluid">
  <div class="row">
        <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="@if(isset($edit->id)) {{route('Admin/FacebookLead/SendEmail')}} @else {{route('Admin/FacebookLead/SendEmail')}} @endif" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card ">
                  ...
                  <div style="background-color: #274CBF; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>
                      Send Mail                     <a href="{{route('Admin/FacebookLead')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#274CBF;">Manage</a></h4>
                  </div>
                  ...
                  <div class="row" style="margin-bottom: 30px;">
                    <label class="col-sm-2 col-form-label">Name :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text" disabled name="Name" disabled  class="form-control" value="@if(isset($edit->id)) {{$edit->Name}} @endif">
                          <input type="hidden" name="Names" disabled  class="form-control" value="@if(isset($edit->id)) {{$edit->Name}} @endif">
                      </div>
                    </div>
                     ...
                     <label class="col-sm-2 col-form-label">Email :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text" disabled  name="Email"  class="form-control" value="@if(isset($edit->id)) {{$edit->Email}} @endif">
                          <input type="hidden"  name="EmailN"  class="form-control" value="@if(isset($edit->id)) {{$edit->Email}} @endif">
                      </div>
                    </div>
                     ...
                     <label class="col-sm-2 col-form-label">Mobile :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input type="text" disabled name="Mobile"  class="form-control" value="@if(isset($edit->id)) {{$edit->Mobile}} @endif">
                      </div>
                    </div>
                    ...
                    <label class="col-sm-2 col-form-label">Source :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                        <select name="Source"  disabled class="form-control" value="@if(isset($edit->id)) {{$edit->Source}} @endif">
                    ...
                    <label class="col-sm-2 col-form-label">Interested :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                        <select name="Interested" disabled class="form-control" value="@if(isset($edit->id)) {{$edit->Interested}} @endif">
                    ...
                    <label class="col-sm-2 col-form-label">Lead Date :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                        <input type="date" name="Date" disabled class="form-control" value="@if(isset($edit->id)) {{$edit->Date}} @endif">
                     ...
                     <label class="col-sm-2 col-form-label">Site Visit Date :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input type="date" disabled name="SiteVisitDate"  class="form-control" value="@if(isset($edit->id)) {{$edit->SiteVisitDate}} @endif">
                    ...
                    <label class="col-sm-2 col-form-label">Message :</label>
                      <div class="col-sm-10">
                        <div class="form-group">
                          <textarea rows="5" name="Message"  placeholder="Message Type Here" class="form-control">@if(isset($edit->id)) {{$edit->Remark}} @endif</textarea>
                      </div>
                    </div>
