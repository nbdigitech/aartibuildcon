        ...
        <div class="container-min-full-height d-flex justify-content-center align-items-center">
            <div class="login-center">
                <div class="navbar-header text-center mt-2 mb-4">
                    <a >
                        <img alt="" src="{{url('/')}}/public/assets/images/logo.png" style="height: 50px; width: 200px;">
                ...
                <form action="{{route('Admin/Login/Attempt')}}" method="post" id="RegisterValidation">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-block btn-lg btn-primary text-uppercase fs-12 fw-600" type="submit" style="background-color: #274CBF; border:none; box-shadow: none;">Login</button>
                    </div>
