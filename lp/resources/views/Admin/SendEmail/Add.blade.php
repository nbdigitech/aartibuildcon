...
<div class="container-fluid">
  <div class="row">
        <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="{{route('Admin/SendEmail/Update')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card ">
                  ...
                  <div style="background-color: #274CBF; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>
                       Send Email                     <a href="{{route('Admin/SendEmail')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#274CBF;">Manage</a></h4>
                  </div>
                  ...
                  <div class="row" style="margin-bottom: 30px;">
                    <label class="col-sm-2 col-form-label">Name :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="Names" value="@if(isset($edit->id)) {{$edit->Name}} @endif">
                      </div>
                    </div>
                    ...
                    <input type="hidden" name="Emaill" value="@if(isset($edit->id)) {{$edit->Email}} @endif">
                    ...
                    <label class="col-sm-2 col-form-label">Message :</label>
                      <div class="col-sm-10">
                        <div class="form-group">
                          <textarea rows="5" name="Message" placeholder="Mail Type Here" class="form-control"></textarea>
                      </div>
                    </div>
