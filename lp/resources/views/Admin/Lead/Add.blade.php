...
<div class="container-fluid">
  <div class="row">
        <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="{{route('Admin/Lead/Update')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card ">
                  ...
                  <div style="background-color: #274CBF; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>
                       Remark Update                     <a href="{{route('Admin/Lead')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#274CBF;">Manage</a></h4>
                  </div>
                  ...
                  <div class="row" style="margin-bottom: 30px;">
                    ...
                    <label class="col-sm-2 col-form-label">Budget :</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                        <input type="text" name="Flat" disabled class="form-control" value="@if(isset($edit->id)) {{$edit->Budget}} @endif">
                      </div>
                    </div>
