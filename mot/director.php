...
<?php
			  ...
			  $query = " SELECT * FROM director123 LIMIT 1";
     ...
     if(isset($_POST['submit'])){
         ...
         if( !empty($_POST['des']) && !empty($_FILES['pro']['tmp_name']) )
	     {
              ...
              $query = "UPDATE director123 SET pro= '$pic', des= '$des' WHERE id= '$a[0]' LIMIT 1";
  ...
  <body>
       ...
       <div class=" jumbotron">
                    ...
                    <div class="container well" style="margin-top: 70px;">
                             ...
                             <form action="director.php" enctype="multipart/form-data" method="post">
