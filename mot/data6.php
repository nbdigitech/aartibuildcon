...
<?php
     ...
     if(isset($_POST['submit'])){
         ...
         if( !empty($_FILES['pic10']['tmp_name']) && !empty($_FILES['pic11']['tmp_name']) && !empty($_FILES['pic12']['tmp_name']) )
	     {
		...
		$pic_type=$_FILES['pic10']['type'];
			   ...
			   if( $pic_type=='image/jpeg' )
				 { $ext = '.jpg'; }	 	 	 	    
			   $pic10 = $nam.'10'.$ext;
			   $target = GW_UPLOADPATH.$pic10;
			   move_uploaded_file($_FILES['pic10']['tmp_name'],$target);
			   ...
			   if( $pic_type=='image/jpeg' )
				 { $ext = '.jpg'; }	 	 	 	    
			   $pic11 = $nam.'11'.$ext;
			   $target = GW_UPLOADPATH.$pic11;
			   move_uploaded_file($_FILES['pic11']['tmp_name'],$target);
			   ...
			   if( $pic_type=='image/jpeg' )
				 { $ext = '.jpg'; }	 	 	 	    
			   $pic12 = $nam.'12'.$ext;
			   $target = GW_UPLOADPATH.$pic12;
			   move_uploaded_file($_FILES['pic12']['tmp_name'],$target);
			  ...
			  $query = "UPDATE data123 SET pic10= '$pic10', pic11= '$pic11', pic12= '$pic12'  WHERE nam= '$nam' LIMIT 1";
  ...
  <body>
       ...
       <div class=" jumbotron">
                    ...
                    <div class="container well" style="margin-top: 70px;">
                             ...
                             <form action="data7.php?nam=<?php echo $nam; ?>" enctype="multipart/form-data" method="post">
                             
                             <h3>Floor design </h3> <br>
                              Pic 1: <input type="file" name="pic13" > <br>
                              Pic 2: <input type="file" name="pic14" > <br>
                              Pic 3: <input type="file" name="pic15" > <br>
